<table class="table table-hover">
    <thead>
    <div class="text-center">Recherche par nom</div>
...
<tbody>   
    ...
    <tr><td><?= $customer->getCustomer_lastname() ?></td><td><?= $customer->getCustomer_firstname() ?></td><td><?= $customer->getCustomer_email() ?></td><td><?= $customer->getCustomer_sms() ?></td><td><?= substr($customer->getCustomer_validation(),0,10 )?></td>
            <td class = "row">
